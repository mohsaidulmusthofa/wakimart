                        ...
                        <form action="{{ route('store.user') }}" method="post">
                            ...
                            <div class="mb-4 row">
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="text" name="user_name" id="user_name" placeholder="Input your name">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="text" name="user_email" id="user_email" placeholder="Input your email">
